...
<html :class="{ 'dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('logo2.png') }}" type="image/jpg">
    <title>@yield('title') |  Egycon Tickets</title>
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
      rel="stylesheet"
    />
    <script src="{{ asset('js/jquery.min.js') }}?v=1.0.0"></script>
